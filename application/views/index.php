				...
				<div class="col-md-4 col-sm-6">
					<div class="media">
						...
						<div class="media-body">
							...
							<p>
								Dimasa depan twitter merupakan jantung sebuah modal pemasaran dan memiliki prospek yang hebat. Kami siap melayani berbagai strategi pemasaran.
							</p>
						</div>
					</div>
				</div><!--/.col-md-4-->
									...
									<div class="col-xs-4">
										<div class="portfolio-item">
											<div class="item-inner">
												...
												<div class="overlay">
													<a class="preview btn btn-danger" title="Malesuada fames ac turpis egestas" href="<?php echo base_url() . "assets/"; ?>images/portfolio/full/item3.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
												</div>
											</div>
										</div>
									</div>
									<div class="col-xs-4">
										<div class="portfolio-item">
											<div class="item-inner">
												...
												<div class="overlay">
													<a class="preview btn btn-danger" title="Malesuada fames ac turpis egestas" href="<?php echo base_url() . "assets/"; ?>images/portfolio/full/item2.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="col-xs-4">
										<div class="portfolio-item">
											<div class="item-inner">
												...
												<h5> Flat Theme - Business Theme </h5>
												<div class="overlay">
													<a class="preview btn btn-danger" title="Malesuada fames ac turpis egestas" href="<?php echo base_url() . "assets/"; ?>images/portfolio/full/item4.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
												</div>
											</div>
										</div>
									</div>
									<div class="col-xs-4">
										<div class="portfolio-item">
											<div class="item-inner">
												...
												<h5> Nova - Corporate site template </h5>
												<div class="overlay">
													<a class="preview btn btn-danger" title="Malesuada fames ac turpis egestas" href="<?php echo base_url() . "assets/"; ?>images/portfolio/full/item5.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
												</div>
											</div>
										</div>
									</div>
